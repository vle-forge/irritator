...
example_qss_seir_nonlinear(simulation& sim, F f) noexcept
{
    ...
    constant_c.default_value = 0.01667;
    ...
    sim.connect(sum_e, 0, qss2_power, 0);
    ...
    sim.connect(pow_a, 0, product_j, 1);

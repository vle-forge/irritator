...
void data_window::show() noexcept
{
    ...
    //     ImGuiTableColumnFlags_WidthStretch); ImGui::TableHeadersRow();
    ...
    //         while (app.pj.sim.srcs.constant_sources.next(cst_src)) {
    //             ImGui::PushID(cst_src);
    //             const auto id =
    //               app.pj.sim.srcs.constant_sources.get_id(cst_src);
    ...
    //         if (cst_src_del)
    //             app.pj.sim.srcs.constant_sources.free(*cst_src_del);
    //     }

    //     {
    //         text_file_source* txt_src     = nullptr;
    //         text_file_source* txt_src_del = nullptr;
    //         while (app.pj.sim.srcs.text_file_sources.next(txt_src)) {
    //             ImGui::PushID(txt_src);

    //             const auto id =
    //               app.pj.sim.srcs.text_file_sources.get_id(txt_src);
    //             const auto index            = get_index(id);
    //             const bool item_is_selected = sel.is(id);
    ...
    //         if (txt_src_del)
    //             app.pj.sim.srcs.text_file_sources.free(*txt_src_del);
    //     }

    //     {
    //         binary_file_source* bin_src     = nullptr;
    //         binary_file_source* bin_src_del = nullptr;
    //         while (app.pj.sim.srcs.binary_file_sources.next(bin_src)) {
    //             ImGui::PushID(bin_src);
    //             const auto id =
    //               app.pj.sim.srcs.binary_file_sources.get_id(bin_src);
    //             const auto index            = get_index(id);
    //             const bool item_is_selected = sel.is(id);
    ...
    //         if (bin_src_del)
    //             app.pj.sim.srcs.binary_file_sources.free(*bin_src_del);
    //     }

    //     {
    //         random_source* rnd_src     = nullptr;
    //         random_source* rnd_src_del = nullptr;
    //         while (app.pj.sim.srcs.random_sources.next(rnd_src)) {
    //             ImGui::PushID(rnd_src);
    //             const auto id =
    //             app.pj.sim.srcs.random_sources.get_id(rnd_src); const auto
    //             index            = get_index(id); const bool item_is_selected
    //             = sel.is(id);

    //             ImGui::TableNextRow();
    //             ImGui::TableNextColumn();
    //             format(
    //               label, "{}-{}", ordinal(source::source_type::random),
    //               index);
    //             if (ImGui::Selectable(label.c_str(),
    //                                   item_is_selected,
    //                                   ImGuiSelectableFlags_SpanAllColumns)) {
    ...
    //         if (rnd_src_del)
    //             app.pj.sim.srcs.random_sources.free(*rnd_src_del);
    //     }
    ...
    //         if (app.pj.sim.srcs.constant_sources.can_alloc(1u)) {
    //             auto& new_src = app.pj.sim.srcs.constant_sources.alloc();
    //             attempt_all(
    //               [&]() noexcept -> status {
    ...
    //         if (app.pj.sim.srcs.text_file_sources.can_alloc(1u)) {
    //             auto& new_src = app.pj.sim.srcs.text_file_sources.alloc();
    //             (void)new_src;
    //             // attempt_all(
    //             //   [&]() noexcept -> status {
    //             //       irt_check(new_src.init());
    ...
    //         if (app.pj.sim.srcs.binary_file_sources.can_alloc(1u)) {
    //             auto& new_src = app.pj.sim.srcs.binary_file_sources.alloc();
    //             (void)new_src;
    //             // attempt_all(
    //             //   [&]() noexcept -> status {
    //             //       irt_check(new_src.init());
    ...
    //         if (app.pj.sim.srcs.random_sources.can_alloc(1u)) {
    //             auto& new_src = app.pj.sim.srcs.random_sources.alloc();
    //             attempt_all(
    //               [&]() noexcept -> status {
    //                   irt_check(new_src.init());
    //                   new_src.a32          = 0;
    ...
    //         if (auto* ptr = app.pj.sim.srcs.constant_sources.try_to_get(id);
    //             ptr) {
    ...
    //         const auto idx = get_index(id);
    //         if (auto* ptr = app.pj.sim.srcs.text_file_sources.try_to_get(id);
    //             ptr) {
    ...
    //             // ImGui::Text("%s",
    //             text_file_ptr->file_path.string().c_str()); if
    //             (ImGui::Button("...")) {
    ...
    //         const auto idx = get_index(id);
    //         if (auto* ptr =
    //         app.pj.sim.srcs.binary_file_sources.try_to_get(id);
    //             ptr) {
    //             ImGui::InputScalar("id",
    //                                ImGuiDataType_U32,
    //                                const_cast<uint32_t*>(&idx),
    ...
    //         const auto idx = get_index(id);
    //         if (auto* ptr = app.pj.sim.srcs.random_sources.try_to_get(id);
    //             ptr) {
    //             ImGui::InputScalar("id",
    //                                ImGuiDataType_U32,
    //                                const_cast<uint32_t*>(&idx),
